...
## Simple graphical implementation of four processor scheduling algorithms using `Python` and `Tkinter` module.</br>
Input is arrival_time, execution_time for each process </br>
